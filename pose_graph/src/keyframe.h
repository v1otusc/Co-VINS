...
class KeyFrame {
 public:
  /*
  KeyFrame(double _time_stamp, int _index, Vector3d &_vio_T_w_i, Matrix3d
  &_vio_R_w_i, Vector3d &_T_w_i, Matrix3d &_R_w_i, cv::Mat &_image, int
  ...
  &_feature_des);
  */
  KeyFrame(int _seq, double _time_stamp, Vector3d &_vio_T_w_i,
